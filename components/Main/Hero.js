...
const Hero = () => {
  return (
    ...
    <div className="relative bg-hero bg-cover bg-center">
        <div className="">
            <div className="h-screen absolute bg-[#F6F5F3] w-24 md:w-32 lg:w-44">
                <div className="w-[15rem] md:w-[23rem] h-[23.75rem] bg-[#F6F5F3]">
            ...
            <div className="lg:container mx-auto relative h-screen">
                <div className="flex h-full items-center text-right justify-end">
                    <div className="space-y-10 mt-56 lg:mt-0 px-4 md:px-16 lg:px-0">
                        <h2 className="text-xl md:text-5xl text-white uppercase tracking-[4px] lg:tracking-[18px] font-oswald lg:-mr-5">Transform Your Space</h2>
                        <h3 className="text-sm md:text-base text-white font-normal ml-[100px] lg:ml-[500px]"><b>SanaModa</b> is an interior design studio that transforms spaces to inspire potential and function trough design. The unexpected and expressive interiors at all design projects are a cocktail of creative intelligence, cultural relevance and flawless execution.</h3>
                    </div>
