        ...
        <div className="flex items-center justify-between container mx-auto">
            ...
            <ul className="hidden xl:flex space-x-16">
                ...
                <div className="xl:hidden absolute right-4 z-10" onClick={handleClick}>
                    <svg width="34" height="24" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 17.5H0.25V14.6667H13V17.5ZM25.75 10.4167H0.25V7.58333H25.75V10.4167ZM25.75 3.33333H13V0.5H25.75V3.33333Z" fill={`${open ? "white" : "#394F76"}`}/></svg>
                </div>           
                : 
                <div className="xl:hidden absolute right-4 z-10 top-12" onClick={handleClick}>
                    <svg width="34" height="24" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 17.5H0.25V14.6667H13V17.5ZM25.75 10.4167H0.25V7.58333H25.75V10.4167ZM25.75 3.33333H13V0.5H25.75V3.33333Z" fill={`${open ? "white" : "#394F76"}`}/></svg>
                </div> 
                }
